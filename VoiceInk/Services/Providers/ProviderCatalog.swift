    ...
    private static func buildEntries() -> [ProviderEntry] {
        [
            ...
            .init(id: .assemblyAI, displayName: "AssemblyAI", category: .cloud,
                  ...
                  summary: "Speech-to-text. LeMUR-style transcript analysis exists but VoiceInk does not route LLM enhancement through AssemblyAI.",
            ...
            .init(id: .deepgram, displayName: "Deepgram", category: .cloud,
                  ...
                  summary: "Deepgram speech-to-text with batch and streaming. No general-purpose LLM endpoint.",
                  iconSystemName: "waveform"),
            ...
            .init(id: .openAI, displayName: "OpenAI", category: .cloud,
                  capabilities: [.stt, .llm], credentialKind: .apiKey,
                  aiProviderRaw: "OpenAI", modelProviderRaw: "OpenAI",
                  signupURL: URL(string: "https://platform.openai.com/api-keys"),
                  summary: "GPT-4o family for LLM enhancement and gpt-4o-transcribe / whisper-1 for cloud speech-to-text.",
                  iconSystemName: "sparkles"),
            ...
            .init(id: .soniox, displayName: "Soniox", category: .cloud,
                  ...
                  summary: "Soniox real-time speech-to-text. No general-purpose LLM endpoint.",
                  iconSystemName: "waveform"),
            .init(id: .speechmatics, displayName: "Speechmatics", category: .cloud,
                  ...
                  summary: "Speechmatics enhanced transcription. No general-purpose LLM endpoint.",
                  iconSystemName: "waveform"),
