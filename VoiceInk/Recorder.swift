...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "agabo.dev.voiceink", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "agabo.dev.voiceink.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "agabo.dev.voiceink.audioSetup", qos: .userInitiated)
